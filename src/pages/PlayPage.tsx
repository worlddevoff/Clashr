    ...
    <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6">
      ...
      <section className="mb-10">
        ...
        <p className="mt-2 text-sm text-white/50">
          {potsOn
            ? 'Public and private Bomb Party parties use the same on-chain escrow as Tower. Every connected wallet stakes before the host can start; bots never stake.'
            : 'Public and private Bomb Party parties are free until real-money pots are enabled. Every connected wallet can join; bots fill empty seats.'}
        </p>
      ...
      <div className="mb-4">
        ...
        <p className="mt-0.5 text-xs text-white/35">
          Practice vs bots is free. Parties are wallet-gated.
        </p>
      </div>
